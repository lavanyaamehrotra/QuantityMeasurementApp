...
//             _persistenceRepo = persistenceRepo ?? throw new ArgumentNullException(nameof(persistenceRepo));
...
//         {
//             _logger.LogInformation("Compare async called");
...
//             await _persistenceRepo.SaveAsync(entity);
...
//             => QuantityMeasurementDto.FromList(await _persistenceRepo.GetByOperationAsync(op));

//         public async Task<IReadOnlyList<QuantityMeasurementDto>> GetHistoryByCategoryAsync(string cat)
//             => QuantityMeasurementDto.FromList(await _persistenceRepo.GetByCategoryAsync(cat));

//         public async Task<IReadOnlyList<QuantityMeasurementDto>> GetErrorHistoryAsync()
//             => QuantityMeasurementDto.FromList(await _persistenceRepo.GetErroredAsync());

//         public async Task<int> GetCountByOperationAsync(string op)
//             => await _persistenceRepo.GetCountByOperationAsync(op);
...
//         private static QuantityDTO ToDto(QuantityRequestDto r)
...
//             {
//                 "LENGTH" => Math.Abs(q1.Value - q2.Value) < 0.01,
//                 "WEIGHT" => Math.Abs(q1.Value - q2.Value) < 0.01,
//                 "VOLUME" => Math.Abs(q1.Value - q2.Value) < 0.01,
//                 "TEMPERATURE" => Math.Abs(q1.Value - q2.Value) < 0.01,
...
//         {
//             return new QuantityDTO(q1.Value, targetUnit, q1.Category);
//         }
...
//             return op switch
//             {
//                 "ADD" => new QuantityDTO(q1.Value + q2.Value, q1.UnitName, q1.Category),
//                 "SUBTRACT" => new QuantityDTO(q1.Value - q2.Value, q1.UnitName, q1.Category),
//                 "DIVIDE" => new QuantityDTO(q1.Value / q2.Value, "RATIO", "SCALAR"),
...
//                 throw new QuantityMeasurementException($"Cannot {operation} across different categories.");
//         }
//     }
// 
using Microsoft.Extensions.Logging;

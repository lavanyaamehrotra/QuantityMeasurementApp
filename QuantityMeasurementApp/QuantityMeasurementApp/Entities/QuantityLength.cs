...
namespace QuantityMeasurementApp.Entities
{
    ...
    public class QuantityLength
    {
        ...
        /// <summary>
        /// UC6: Adds another QuantityLength to this one.
        /// Both lengths must be non-null with valid units and finite values.
        /// Result is returned in the unit of this (first) operand.
        /// Addition pipeline: convert both to base unit (feet) -> sum -> convert to this unit -> round to 2 decimals.
        /// </summary>
        /// <param name="thatLength">The QuantityLength to add. Must not be null.</param>
        /// <returns>New QuantityLength representing the sum in this instance's unit.</returns>

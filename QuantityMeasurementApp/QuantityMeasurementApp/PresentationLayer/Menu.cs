...
namespace QuantityMeasurementApp.PresentationLayer
{
    ...
    public class Menu
    {
        ...
        public void Start()
        {
            ...
            while (running)
            {
                ...
                switch (choice)
                {
                    ...
                    case "12": RunUC14ComingSoon(); break;
                    case "13":
                        running = false;
        ...
        // ================= UC14 - Temperature Measurement (Coming Soon) =================
        private void RunUC14ComingSoon()
        {
            Console.Clear();
            Console.WriteLine("+----------------------------------------------------------+");
            Console.WriteLine("|  UC14: Temperature Measurement with Selective Arithmetic  |");
            Console.WriteLine("|         Support and IMeasurable Refactoring               |");
            Console.WriteLine("+----------------------------------------------------------+");
            Console.WriteLine();
